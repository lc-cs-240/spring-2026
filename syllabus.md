...
[Google Classroom](https://classroom.google.com/c/ODI4NDU1MDcyMzc1) throughout
the semester to share some assignment due dates and details about exams, and
track your grade. You'll need to log in your Lewis & Clark account to access it.

**GitHub:** I will also use [GitHub](https://github.com/lc-cs-240/spring-2026)
to share some information. This is a one-way communication conduit; you won't
make any changes in there.

**Required Text book:** Databases. Paul Winsberg. Interactive Textbook through
zyBooks. The cost is $69. Each student must enroll using their Lewis & Clark
account following these steps:

1. Sign in or create an account at learn.zybooks.com
2. Enter zyBook code: LCLARKCS240KagiWinter2026
3. Subscribe

Unfortunately, this resource cannot synched with Google classroom. It means that
you will need to check both places for assignments. Most of the reading
assignments will be posted through the textbook. Other assignments (e.g.,
projects) will be posted on Google classroom. Grade information will only be
stored on Google classroom.

**On reserve at Watzek:** For those interested in the finer points of relational
databases, I have placed the following two books on reserve at the Watzek
library:

* The theory of relational database. David Maier. Computer Science Press. 1983.
...
This course introduces some fundamental ideas in database systems. A database is
a collection of structured data. But why do we need a database; why can't we
just use a plain file or a spreadsheet?  This class will answer this important
question. We will learn how to design, cre­ate, manipulate, and access a
database.
...
* Organize your data and recognize relationships among that data

* Structure your data to eliminate redundancy and improve integrity

* Create a relational database from your data and its structure

* Understand database transactions

* Create simple queries for your data

* Improve your database performance

* Develop a web interface for your data and its queries
...
or 305. If you would like to make an appointment outside of my office hours,
please email me at alaink@lclark.edu.

## Requirements

All assignments will be posted through a combination of the textbook and Google 
classroom and will be submitted through these resources. Assignments are
designed to help you master and apply what we are learning in class.
**Assignments are due at 11:59 PM on the day they are due.** Points will be
taken off if submitted late; in some cases, late assignments will not receive
any credit.
...
* Participation activities (in the textbook): 10%
* Challenge activities (in the textbook): 20%
* Homeworks: 20%
* Exams: 25%
* Project: 25%
...
* W1-2: Database design
* W3-5: Relational databases
* W6-8: Structured query language
* W9-11: Data storage
* W12-14: Transaction management
* W15-16: Database programming
